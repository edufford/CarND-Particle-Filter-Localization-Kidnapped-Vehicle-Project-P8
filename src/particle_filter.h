...
public:
  ...
  /**
   * Prediction Predicts the state for the next time step using the
   *   process model.
  ...
  /**
   * SetAssociations Set a particle's list of associations, along with the
   * associations' calculated world x,y coordinates.  This can be a very useful
   * debugging tool to make sure transformations are correct and assocations
